...
for ii, year in enumerate(range(1979, 2019)):
    ...
    df.drop(['Unnamed: 0', 'Rk', 'Pos', 'Age', 'Tm', 'G', 'GS', 'FG%', '3P%', '2P%', 'FT%'], axis = 1, inplace = True)
